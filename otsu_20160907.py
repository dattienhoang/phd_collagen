...
filedir = 'C:/Users/Dat Tien Hoang/Desktop/hoa_fluo/otsutest/'
files = []
for i in os.listdir(filedir):
    files.append(filedir+i)
files.sort()
print files
...
for frame in files:
    ...
    # FOR GREYSCALE IMAGES...like angle data
    ...
    #fig2 = plt.figure()
    #plt.imshow(gray*0.708, vmin = 0, vmax = 255) #multiplied for display purposes...just scaled 360 to 255
    #plt.colorbar()
    ...
    frno = os.path.basename(frame).split('_')[1].split('.')[0]
    cv2.imwrite(filedir+'angotsu_' + str(frno) + '.png',thresh)
    #fig4 = plt.figure()
